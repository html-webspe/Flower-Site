...
document.addEventListener('DOMContentLoaded', function () {
      ...
      var select = function select() {
         $.each($('select'), function (index, val) {
            ...
            if ($(this).attr('data-type') == 'search') {
               sblock.append("<div data-type='search' class='select_" + ind + " select" + " " + $(this).attr('class') + "__select " + milti + "'>" + "<div class='select-title'>" + "<div class='select-title__arrow icon-arrow-down'></div>" + "<input data-value='" + $(this).find('option[selected="selected"]').html() + "' class='select-title__value value_" + $(this).find('option[selected="selected"]').val() + "' />" + "</div>" + soptions + "</div>");
               ...
               sblock.append("<div class='select_" + ind + " select" + " " + $(this).attr('class') + "__select " + milti + "'>" + "<div class='select-title'>" + "<div class='select-title__arrow icon-arrow-down'></div>" + "<div class='select-title__value value_" + $(this).find('option[selected="selected"]').val() + "'>" + $(this).find('option[selected="selected"]').html() + "</div>" + "</div>" + soptions + "</div>");
            }
   ...
   //====================  <!-- Fixed -->========================//
   var topOffset = document.querySelector('.wrapper');

   var positionFixed = function positionFixed(element, poinst) {
      window.addEventListener('scroll', function () {
         var scrollDistens = window.scrollY;

         var headerHeight = document.getElementById(element).offsetHeight;

         var scrollPos = poinst,
   ...
   if (document.querySelector('.category__slider-container')) {
      var categorySLider = new Swiper('.category__slider-container', {
         slidesPerView: 1,
         loop: true,
         observer: true,
         observeParents: true,
      ...
      var swiperPrev = document.querySelector('.slider__button-prev');
      var swiperNext = document.querySelector('.slider__button-next');
   ...
   /*==================== //FAVORITES ====================*/
   /*====================   CARD SLIDER  ====================*/
   var cardSlider = new Swiper('.slider-block', {
      //effect: "fade",
   });
   var sliderNavItem = document.querySelectorAll('.slider-nav__item');

   sliderNavItem.forEach(function (el, index) {
      ...
      el.addEventListener('click', function (e) {
         ...
         document.querySelectorAll('.slider-nav__item').forEach(function (e) {
   ...
   */
   ...
   function resizeScrenn() {
      if ($(window).width() < 576.98) {
         ...
         if ($(".page-checkout").length > 0) {
            ...
            var _productItem = document.querySelectorAll('.product__item');
            var _productWrapper = document.querySelectorAll('.product__wrapper');

            _productWrapper.forEach(function (el) {
               el.classList.add('swiper-wrapper');
            });
            _productItem.forEach(function (el) {
               el.classList.add('swiper-slide');
            });
   ...
   var tabsBtn = document.querySelectorAll(".time-order__head-item");
   var tabsItems = document.querySelectorAll(".time-order__body-item");
